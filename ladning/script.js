...
(function() {
    ...
    function createScrollProgress() {
        ...
        progressBar.style.background = 'linear-gradient(90deg, #0369a0, #048bc4)';
    ...
    console.log(
        '%cPro Rise AI 🚀',
        'color: #0369a0; font-size: 28px; font-weight: bold; text-shadow: 2px 2px 4px rgba(3, 105, 160, 0.3);'
    );
    console.log(
    ...
    console.log(
        ...
        'color: #0369a0; font-size: 14px; font-weight: bold;'
    );
